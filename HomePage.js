      ...
      <TouchableWithoutFeedback>
        <View style={styles.container}>
          ...
          <View style={styles.mainContent}>
            ...
            {/* Content */}
            <TouchableWithoutFeedback onPress={()=>this.hideToggleSidebar()} style={{height:'100%'}}>
            <Animated.View style={[styles.content, { backgroundColor: isSidebarOpen ? 'rgba(0,0,0,0.3)' : '#FFF' }]}>
